...
import image from '../assets/40.png'
...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen min-h-screen grid grid-cols-1 md:grid-cols-2">
      {/* Left: Form Section */}
      <div className="flex items-center justify-center bg-gray-50 p-6 h-full">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white p-12 shadow-sm w-full max-w-xl"
        >
          <motion.div
            initial={{ scale: 0.95 }}
            animate={{ scale: 1 }}
          ...
          >
            <div className="h-20 w-20 bg-gray-900 xl flex items-center justify-center shadow-lg" style={{backgroundColor: '#1F263E'}}>
              <LogInIcon className="h-10 w-10 text-white" />
            </div>
          </motion.div>

          <h1 className="text-4xl font-bold text-center text-gray-900 mb-8" style={{color: '#273446'}}>
            Welcome Back
          </h1>
