    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Admin User Settings">
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-end space-x-3">
          ...
          <button
            type="submit"
            className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:cursor-not-allowed"
