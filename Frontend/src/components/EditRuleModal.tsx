...
const token =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NDY3OTM2ODgsInJvbGUiOiJzdXBlcl9hZG1pbiIsInVzZXJfaWQiOiJiNGM1ZjI0OC1iOTE3LTQyNDMtYjE0ZS1kNmI4NWQ2NzZjODgifQ.72S_RB-PCbC7oqwKDfgN1ufJBxK70j6KIKPvzya6y4I'
...
const EditRuleModal: React.FC<EditRuleModalProps> = ({ruleID, onClose, onSuccess}) => {
  ...
  const saveRule = async () => {
    ...
    try {
      await axios.put(
        `${backendUrl}/rule/update/${ruleInput.ruleID}`,
        {
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto space-y-4">
      ...
      <div className="flex gap-4">
        <button className="bg-green-600 text-white px-4 py-2 rounded" onClick={saveRule}>
          Save Changes
        </button>
